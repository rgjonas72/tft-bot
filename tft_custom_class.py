...
class tft_stuff_class():
    ...
    def construct_champ(self, champ, items, image_size=48):
        ...
        for item in items:
            ...
            items_array.append(Image.open(BytesIO(requests.get(f'https://cdn.metatft.com/cdn-cgi/image/width=48,height=48,format=auto/https://cdn.metatft.com/file/metatft/items/{item.lower()}.png').content)).resize((48, 48), Image.LANCZOS))
